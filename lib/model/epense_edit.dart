...
class edit_post extends StatefulWidget {
  ...
  edit_post(this.id);
  @override
  State<edit_post> createState() => _AddState();
}

class _AddState extends State<edit_post> {
  ...
  Future<void> update(id, String id2, urlx) {
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      child: Container(
                                                                          decoration: BoxDecoration(
                                                                            border:
                                                                                Border.all(color: pen ? Colors.transparent : Colors.blue, width: 2),
                                                                            borderRadius: pen
                                                                                ? BorderRadius.circular(10)
                                                                                : BorderRadius.circular(15),
                                                                            color: pending
